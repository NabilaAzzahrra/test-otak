...
const Questions = () => {
  ...
  const handleOptionSelect = (event) => {
    ...
    let dataSelect = localStorage.getItem("selectedOption");
    ...
    localStorage.setItem("selectedOption", JSON.stringify(bucket));
  };
  ...
  const handleSubmit = async (selectedOption) => {
    ...
    const dataStorage = localStorage.getItem("selectedOption");
    if (dataStorage) {
      let data = JSON.parse(dataStorage);
      console.log(data);
      await axios
        .post("https://api.politekniklp3i-tasikmalaya.ac.id/brain/answers", data)
        .then((res) => {
          console.log(res);
        })
        .catch((err) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="bg-white mb-10 pb-14 p-10 shadow-lg rounded rounded-3xl w-full mx-20 flex flex-col md:flex-row md:flex gap-20 items-center justify-center animate-slide-down"
        data-aos="fade-down"
        data-aos-delay="400"
      >
        <div className="gap-5 items-center justify-center md:w-[500px]">
      ...
      <form onSubmit={handleSubmit} method="post" id="nameForm">
        ...
        <button
          ...
          className="bg-white p-4 w-28 flex items-center justify-center font-bold border border-2 border-black hover:bg-black hover:text-white"
          type="submit"
